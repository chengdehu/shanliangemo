...
public class LoadTypeTask extends Thread {
	Handler handler;
	String itemtype;
	public  LoadTypeTask(String itemtype,Handler handler) {
		this.itemtype = itemtype;
		this.handler = handler;// TODO Auto-generated constructor stub
	}
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/EntertainmentType?itemtype="+ itemtype;
