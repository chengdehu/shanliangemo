...
public class LoadEntertainmentTask extends Thread {
	Handler handler;
	public LoadEntertainmentTask(Handler handler) {
		this.handler = handler;// TODO Auto-generated constructor stub
	}
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/Entertainmentshow";
