...
public class LoadCommentTask extends Thread {
	Handler handler;
	int itemid;
	public  LoadCommentTask(int itemid,Handler handler) {
		this.itemid = itemid;
		this.handler = handler;// TODO Auto-generated constructor stub
	}
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Final/ItemCommentShow?itemid="+ itemid;
