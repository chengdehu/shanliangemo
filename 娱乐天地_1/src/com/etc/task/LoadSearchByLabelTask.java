...
public class LoadSearchByLabelTask extends Thread {
	String itemtype;
	String label_name;
	Handler handler;
	public  LoadSearchByLabelTask(String itemtype,String label_name,Handler handler) {
	...
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/Entertainmentlabelsearch?itemtype="+itemtype+"&&label_name="+label_name;
