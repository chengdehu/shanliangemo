...
public class LoadChatRecordTask extends Thread {
	...
	public LoadChatRecordTask(int fromUserid, int toUserid, Handler handler) {
	...
	public void run() {
		// 杩滅▼鏁版嵁鍦板潃
		String url = "http://10.0.2.2:8080/Entertainment/ChatRecordServlet?fromUserid=" + fromUserid + "&toUserid=" + toUserid;
		// 璁剧疆瓒呮椂鍊�
