...
public class LoadLabelTask extends Thread {
	Handler handler;
	String itemtype;
	public LoadLabelTask(String itemtype,Handler handler){
		this.handler = handler;
		this.itemtype = itemtype;
	}
	
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/Enterlabelsearch?itemtype="+ itemtype;
