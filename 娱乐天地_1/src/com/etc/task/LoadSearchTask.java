...
public class LoadSearchTask extends Thread {
	Handler handler;
	String words;
	public  LoadSearchTask(String words,Handler handler) {
		this.words = words;
		this.handler = handler;// TODO Auto-generated constructor stub
	}
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/Entertainmentsearch?words="+ words;
