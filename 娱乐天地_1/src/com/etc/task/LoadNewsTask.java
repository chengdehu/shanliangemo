...
public class LoadNewsTask extends Thread {
	Handler handler;
	int userid;
	String itemtype;
	public  LoadNewsTask(int userid,String itemtype,Handler handler) {
		this.userid = userid;
	...
	@Override
	public void run() {
		String uri =  "http://10.0.2.2:8080/Entertainment/UserRecommendServlet?itemtype="+itemtype+"&&userid="+userid;
