...
public class LoadArticleCollectionTask extends Thread {
	int lastid,pagesize;
	Handler handler;
	public LoadArticleCollectionTask(int lastid, int pagesize,Handler handler) {
		this.lastid = lastid;
	...
	public void run() {
		//远程数据地址
		String uri ="http://10.0.2.2:8080/Entertainment/ArticleCollectionServlet?lastid=" + lastid+"&pagesize="+ pagesize;
		// 设定超时
