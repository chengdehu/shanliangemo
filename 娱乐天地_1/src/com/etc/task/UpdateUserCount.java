...
public class UpdateUserCount extends Thread {
	Handler handler;
	int itemid;
	int userid;
	public UpdateUserCount(int itemid,int userid,Handler handler){
	...
	public void run() {
		String uri =  "http://10.0.2.2:8080/Final/UserLabelServlet?itemid="+ itemid+"&&userid="+userid;
