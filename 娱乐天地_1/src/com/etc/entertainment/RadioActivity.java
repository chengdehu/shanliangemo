...
public class RadioActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lvwMyRadio = (ListView) findViewById(R.id.lvwMyRadio);
		...
		lvwMyRadio.setAdapter(adapter);
		
		//锟斤拷锟铰硷拷锟斤拷锟斤拷锟斤拷
		lvwMyRadio.setOnItemClickListener(new OnItemClickListenerImpl());
	...
	public void back3(View v){
		...
		Intent intent = new Intent(RadioActivity.this, PersonInfoActivity.class);
